...
class FarmerFollowUP1 extends StatefulWidget {
  ...
  FarmerFollowUP1(this.Farmer, this.fid, this.FarmerDemandMap);

  @override
  State<FarmerFollowUP1> createState() => _FarmerFollowUP1State();
}

class _FarmerFollowUP1State extends State<FarmerFollowUP1> {
                                    ...
                                    onPressed: (){
                                      XFile? image;
                                        ...
                                        Navigator.push(context, MaterialPageRoute(builder: (context) =>
                                            FarmerFollowUp1FConsent(widget.Farmer, "true", widget.fid, tree_type,
      ...
      actions: <Widget>[
        new FlatButton(
          onPressed: () {
            ...
            Navigator.of(context).pop();
            Navigator.of(context).pop();
            Navigator.push(context, MaterialPageRoute(builder: (context) => FarmerFollowUP1(
