...
import 'follow_up_2_farmer_cons.dart';



class FarmerFollowUP2 extends StatefulWidget {
  ...
  FarmerFollowUP2(this.Farmer, this.fid, this.FarmerDemandMap);

  @override
  State<FarmerFollowUP2> createState() => _FarmerFollowUP2State();
}

class _FarmerFollowUP2State extends State<FarmerFollowUP2> {
                                    ...
                                    onPressed: (){
                                      XFile? image;
                                        ...
                                        Navigator.push(context, MaterialPageRoute(builder: (context) =>
                                            FarmerFollowUp2FConsent(widget.Farmer, "true", widget.fid, tree_type,
      ...
      actions: <Widget>[
        new FlatButton(
          onPressed: () {
            ...
            Navigator.of(context).pop();
            Navigator.of(context).pop();
            Navigator.push(context, MaterialPageRoute(builder: (context) => FarmerFollowUP2(
