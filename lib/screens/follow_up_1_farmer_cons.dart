...
class FarmerFollowUp1FConsent extends StatefulWidget {
  ...
  FarmerFollowUp1FConsent(this.farmerName, this.farmerChecked, this.fid,
      this.tree_type, this.selected_tree, this.qty, this.imageFarmer, this.treeImage);

  @override
  State<FarmerFollowUp1FConsent> createState() => _FarmerFollowUp1FConsentState();
}

class _FarmerFollowUp1FConsentState extends State<FarmerFollowUp1FConsent> {
        ...
        new FlatButton(
          onPressed: () {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (BuildContext context) => FarmerFollowUp1FConsent(widget.farmerName, widget.farmerChecked, widget.fid, widget.tree_type, widget.selected_tree, widget.qty, image12, widget.treeImage)),
            );
          },
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: (){
                      ...
                      if(FarmerData1["farmer_image"].toString()==""){
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) => FarmerFollowUp1SConsent(
